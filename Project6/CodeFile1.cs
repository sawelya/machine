...
// Считаю, монет с другим номиналом не существует
...
class Machine_job
{
    ...
    static void Main()
    {
        ...
        for (; ; )
        {
            Console.WriteLine("У нас следующие товары");
            Console.WriteLine("Кексы имеют идентификатор 1 и стоят 50 рублей штука");
            Console.WriteLine("Печенье имеет идентификатор 2 и стоит 10 рублей штука");
            Console.WriteLine("Вафли имеют идентификатор 3 и стоят 30 рублей штука");
            ...
            if (command == 7){
                ...
                else
                {
                    ...
                    Console.WriteLine("Вы не получили сдачу в полном объеме, обратитесь пожалуйста к администратору автомата");
                    break;
                }
            }
            Console.WriteLine();
